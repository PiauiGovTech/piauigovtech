...
export default function ChatLoginPopover({ open, onClose, onSuccess }: Props) {
  ...
  return (
    <div
      ref={ref}
      className={[
        'fixed bottom-6 right-6 z-50 w-[88vw] max-w-[320px] rounded-xl border border-white/15 bg-white/10 backdrop-blur-3xl text-white shadow-xl ring-1 ring-inset ring-white/10',
