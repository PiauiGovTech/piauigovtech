...
export default function Ecossistema() {
  return (
    <section className="relative bg-brand-100 py-20 h-[calc(50vh)] flex flex-col">
      ...
      <Container className="h-full flex flex-col">
        <div className="flex-1 flex items-center justify-center">
          <div className="mx-auto max-w-4xl text-center">
            ...
            Nosso ecossistema conecta governos em diferentes níveis, instituições de pesquisa e inovação, empresas e startups e a sociedade civil para transformar problemas públicos em desafios claros e soluções aplicadas.



Promovemos parcerias, lançamos chamadas e programas, e mantemos ambientes de teste que reduzem riscos e aceleram a passagem da ideia para a implementação.
            </p>
          </div>
        </div>
      </Container>
