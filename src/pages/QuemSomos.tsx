      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="hidden lg:flex lg:gap-x-2">
            ...
            <NavLink targetId="noticias" to="/noticias">
              Notícias
            </NavLink>
            <NavLink targetId="quem-somos" to="/quemsomos">
              Quem somos
            </NavLink>
          ...
          <div className="lg:hidden">
            ...
            <div className="fixed inset-x-0 top-0 z-50 w-full max-h-[80vh] overflow-y-auto rounded-b-2xl border border-white/15 bg-white/10 backdrop-blur-md p-6 ring-1 ring-inset ring-white/10">
                ...
                >
                  ...
                  <div className="flex items-center gap-3 text-brand-400">
                    ...
                    <div className="leading-tight">
                      <div className="text-lg font-bold text-white">
                        piauí
                        <span className="text-gray-300 font-light">gov</span>
                        tech
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-6 space-y-3">
                <NavLink
                  className="flex w-full items-center rounded-xl px-4 py-3 bg-white/10 border border-white/15 text-white hover:bg-white/15"
                  targetId="inicio"
